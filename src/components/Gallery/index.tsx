...
import Card from "wangyong-design/lib/Card"
import Img from "../../assets/JamalMurray.webp"
...
const Gallery: FC = () => {
    ...
    return (
        <div className={c("gallery")}>
            ...
            <Card id={"001"} name={"贾马尔·穆雷"} imgUrl={Img} captureTime={""} captureAddress={""} haveVehicle={true} />
        </div>
    )
}
